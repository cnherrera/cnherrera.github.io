...
### This collaborative web page is throught to collaborate. Tips, help, improvement on your scripts to handle your (big) data. There are two approaches we have identified, data organization and data processing.
